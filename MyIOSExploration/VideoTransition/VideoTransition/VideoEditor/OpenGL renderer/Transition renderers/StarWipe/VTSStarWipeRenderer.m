...
NSString *const kPassThroughStarWipeFragmentShader = SHADER_STRING
(
...
@interface VTSStarWipeRenderer ()

@end

@implementation VTSStarWipeRenderer

- (NSString *)fragmentShaderString {
    return kPassThroughStarWipeFragmentShader;
}
