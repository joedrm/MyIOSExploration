...
static const CGFloat CSToastOpacity             = 0.9; //透明度
...
// shadow appearance
static const CGFloat CSToastShadowOpacity       = 0.75;
...
//    activityView.backgroundColor = [[UIColor colorWithRed:0.02 green:0.04 blue:0.17 alpha:1] colorWithAlphaComponent:CSToastOpacity];
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    wrapperView.layer.cornerRadius = CSToastMaxWidth;
    ...
    if (CSToastDisplayShadow) {
        ...
        wrapperView.layer.cornerRadius = 26; //新增
    }

    //wrapperView.backgroundColor = [[UIColor colorWithRed:0.02 green:0.04 blue:0.17 alpha:1] colorWithAlphaComponent:CSToastOpacity];
    ...
    if(image != nil) {
        ...
        imageView.layer.cornerRadius = 15;  //新增
    }
...
//    CGFloat wrapperHeight = MAX((messageTop + messageHeight + CSToastVerticalPadding), (imageHeight + (CSToastVerticalPadding * 2)));
    ...
    CGFloat wrapperWidth = [UIScreen mainScreen].bounds.size.width - 50;
    
    CGFloat wrapperHeight = MAX((messageTop + messageHeight + CSToastVerticalPadding), (imageHeight + (CSToastVerticalPadding * 2))) + 15;
    ...
    if(messageLabel != nil) {
        ...
        messageLabel.bounds = CGRectMake(0, 0, messageWidth, messageHeight);
